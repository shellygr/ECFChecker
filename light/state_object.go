...
func (c *StateObject) GetterGas() *big.Int { panic("GetterGas on StateObject should never be called") }
func (c *StateObject) GetterUsedGas() *big.Int { panic ("GetterUsedGas on StateObject should never be called") }
