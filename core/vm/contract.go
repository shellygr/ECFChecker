...
// GetterGas returns the gas of the contract
func (c *Contract) GetterGas() *big.Int {
	return c.Gas
}

// GetterUsedGas returns the gas used by the contract
func (c *Contract) GetterUsedGas() *big.Int {
	return c.UsedGas
}
