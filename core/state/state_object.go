...
func (c *StateObject) GetterGas() *big.Int {
	return big.NewInt(0) /*panic("GetterGas on StateObject should never be called")*/
}
func (c *StateObject) GetterUsedGas() *big.Int {
	return big.NewInt(0) /*panic("GetterUsedGas on StateObject should never be called")*/
}
