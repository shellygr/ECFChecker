...
func (d *Downloader) syncWithPeer(p *peer, hash common.Hash, td *big.Int) (err error) {
	...
	case FastSync:
		...
		vm.ImportantDebug("Fast syncing until pivot block #%d", pivot)
		pivot = 2715000
		vm.ImportantDebug("Shelly resetted the pivot to right after state cleanup, around Nov 29th 2016, block #%d", pivot)
	}
